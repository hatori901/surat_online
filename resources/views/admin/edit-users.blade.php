          ...
          <ol class="flex items-center space-x-4">
            ...
            <li>
                <div class="flex items-center">
                  ...
                  <a href="{{ route('users') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Users</a>
                </div>
              </li>
            <li>
              <div class="flex items-center">
...
<main class="sm:container sm:mx-auto sm:mt-10">
    <div class="w-full sm:px-6">
        ...
        <div class="bg-white shadow-md-rounded-md">
            <form class="divide-y divide-gray-200 lg:col-span-9" action="{{ route('users.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="py-6 px-4 sm:p-6 lg:pb-8">
                    ...
                    <div class="flex-grow space-y-6">
                      <div>
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                          <input type="text" name="name" id="name" value="{{ $user->name }}" readonly class="focus:ring-blue-500 focus:border-blue-500 flex-grow block w-full min-w-0 rounded-md sm:text-sm border-gray-300" value="deblewis">
                        </div>
                      </div>
                      <div>
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                          <input type="email" name="email" id="email" value="{{ $user->email }}" readonly class="focus:ring-blue-500 focus:border-blue-500 flex-grow block w-full min-w-0 rounded-md sm:text-sm border-gray-300" value="deblewis">
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div class="mt-1">
                          <textarea id="alamat" name="alamat" rows="3" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $user->alamat == NULL ? '' : $user->alamat }}</textarea>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-grow-0 lg:flex-shrink-0">
                      ...
                      <div class="mt-1 lg:hidden">
                        <div class="flex items-center">
                          <div class="flex-shrink-0 inline-block rounded-full overflow-hidden h-12 w-12" aria-hidden="true">
                            ...
                            @else
                            <img class="rounded-full h-full w-full" src="{{ asset($user->profile) }}" alt="">
                            @endif
                      ...
                      <div class="hidden relative rounded-full overflow-hidden lg:block">
                        @if ($user->profile == NULL)
                            ...
                            @else
                            <img class="rounded-full h-40 w-40" src="{{ asset($user->profile) }}" alt="">
                            @endif
                  ...
                  <div class="mt-6 grid grid-cols-12 gap-6">
                    <div class="col-span-12 sm:col-span-6 mt-6">
                        ...
                        <div class="mt-1">
                          <input type="text" name="sekolah" id="sekolah" value="{{ $user->sekolah }}" readonly class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                      </div>
                      ...
                      <div class="col-span-12 sm:col-span-6 mt-6">
                        ...
                        <div class="mt-1">
                            ...
                            <input type="hidden" name="kelas" value="{{ $user->kelas_id }}">
                            @endif
                    ...
                    <div class="col-span-12 sm:col-span-6 mt-6">
                      ...
                      <input type="number" name="phone_number" id="phone_number" value="{{ $user->phone_number == NULL ? '' : $user->phone_number }}" class="appearance-none mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                  </div>
